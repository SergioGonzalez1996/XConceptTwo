...
namespace XConceptTwo
{
    public partial class MainPage : ContentPage
    {
        ...
        private async void ConvertButton_Clicked(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Error", "Debes seleccionar la moneda de destino", "Aceptar");
                return;
            }
            ...
            convertedLabel.Text = string.Format("{0:N2} {1} = {2:N2} {3}",
                amount,
        ...
        private async void LoadRates()
        {
            ...
            try
            {
                ...
                var url = "/api/latest.json?app_id=f8672f0d17684dbdb6973187b3b17fc3";
        ...
        {
            LoadPickers(sourcePicker);
            LoadPickers(targetPicker);
        }

        private void LoadPickers(Picker picker)
        {
